...
class HighRisk extends StatefulWidget {
  ...
  @override
  State<HighRisk> createState() => _HighRiskState();
}
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text(
                            'ท่านเป็นผู้ที่มีความเสี่ยงต่อการเป็นมะเร็งเต้านมสูงกว่าสตรีทั่วไป ขอแนะนำให้ท่านไปพบแพทย์เพื่อทำการตรวจคัดกรองเพิ่มเติมอย่างหมาะสมต่อไป',
                            style: TextStyle(color: Colors.black, fontSize: isPhone(context) ? 22 : 32, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                    ),
